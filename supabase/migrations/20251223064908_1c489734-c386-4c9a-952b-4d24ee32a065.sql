-- Update the sync function to treat 'approved' the same as 'active' for public visibility
...
-- Also update the RLS policy for businesses_public to allow both statuses
